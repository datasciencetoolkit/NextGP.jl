...
struct GBLUPType <: RandomEffect
	...
	G::Union{Matrix{Union{Float64, Int64}},String}
end
...
"""
GBLUP(v::Float64;w::Vector{Float64}=Float64[],methodG::Int=1,G::Matrix{Union{Float64, Int64}}=Matrix{Float64}(undef,0,0)) = GBLUPType(v,w,methodG,G)
