...
@time	       	varE = sampleVarE(E[:df],E[:scale],ycorr,nData)
@time		varE = sampleVarE(E,ycorr,nData)
...
#main sampler with weighted residuals
function runSampler_D!(ycorr,nData,E,X,b,Z,u,varU,M,beta,varBeta,delta,chainLength,burnIn,outputFreq,outPut)
